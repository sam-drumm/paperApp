...
const styles = {
  wrapper: 'flex items-center justify-center flex-[3] border-l border-r bg-[#d6fff6]',
  ...
  space: 'w-[.5rem]',
  bannerContainer: 'h-[18rem] w-full grid center overflow-hidden mb-[2rem] rounded-md',
  articleMainContainer: 'flex flex-col gap-[1rem]',
  title: 'font-bold text-3xl font-PermanentMarker text-[#231651]',
