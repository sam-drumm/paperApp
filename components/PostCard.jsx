...
const styles = {
  ...
  title: 'font-bold text-2xl font-PermanentMarker text-[#231651]',
          ...
          <div className={styles.postDetails}>
            ...
            <div className={styles.detailsContainer}>
              <span className={styles.articleDetails}>
                ...
                • {post.data.postLength} min read • <span className={styles.category}>
                  {capsFirst(post.data.category) }</span></span>
              <span className={styles.bookmarkContainer}><BsPinAngle className='w-5, h-5'/></span>
            </div>
          </div>
